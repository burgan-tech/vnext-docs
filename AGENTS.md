...
This file provides guidance to Codex (and any AGENTS.md-compatible agent) when contributing to the **vNext documentation portal**.

> **Keep `CLAUDE.md` in sync with this file** — both describe the same rules; `CLAUDE.md` exists for Claude Code. When you change one, update the other.
