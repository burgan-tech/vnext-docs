---
slug: release-v0-0-44-50
title: Release v0.0.44-50
authors: [vnext-team]
tags: [release]
date: 2026-04-25
---
...
**Documentation:** [Transitions](/docs/components/workflow), [Workflow Definition](/docs/components/workflow)
...
**Documentation:** [HTTP Task](/docs/components/tasks/http), [Dapr Service Task](/docs/components/tasks/dapr-service), [Trigger Tasks](/docs/components/tasks/trigger)
...
> **Note:** Schema package **0.0.50** is the documented pairing with this runtime. The `task-definition.schema.json` and `workflow-definition.schema.json` include new fields (`acceptedStatusCodes`, `timeout.mapping`). Update domain **`validate.js`** / **Ajv2019** usage per [Schema Management](/docs/components/workflow).
