---
slug: release-v0-0-21
title: Release v0.0.21
authors: [vnext-team]
tags: [release]
date: 2025-11-27
---
...
> **Documentation:** See [Trigger Task Types](/docs/components/tasks/trigger) for complete usage examples and best practices.
...
> **Documentation:** See [Function APIs](/docs/components/functions/built-in#instance-verilerini-filtreleme) for complete filtering documentation.
...
> **Documentation:** See [Mapping Guide](/docs/components/mappings#queryparameters) for complete usage examples.
...
> **Documentation:** See [Instance Data](/docs/concepts/instance-data) for complete examples.
...
- [Trigger Task Types](/docs/components/tasks/trigger) - Complete guide for all four task types
- [Function APIs - Filtering](/docs/components/functions/built-in#instance-verilerini-filtreleme) - Data function filtering documentation
- [Mapping Guide - QueryParameters](/docs/components/mappings#queryparameters) - QueryParameters usage in ScriptContext
- [Instance Data](/docs/concepts/instance-data) - Instance Key support in transitions

Turkish documentation:
- [Trigger Task Türleri](/docs/components/tasks/trigger)
- [Function API'leri - Filtreleme](/docs/components/functions/built-in#instance-verilerini-filtreleme)
- [Mapping Rehberi - QueryParameters](/docs/components/mappings#queryparameters)
