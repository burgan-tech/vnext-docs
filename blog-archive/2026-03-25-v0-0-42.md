---
slug: release-v0-0-42
title: Release v0.0.42
authors: [vnext-team]
tags: [release]
date: 2026-03-25
---
...
**Documentation:** [Mapping Guide — ScriptBase](/docs/components/mappings#scriptbase-kullanımı) (see **Collection and dynamic object helpers**). **Runnable sample mappings:** [`release/extra/script-base-usage/`](https://github.com/burgan-tech/vnext-runtime/blob/main/release/extra/script-base-usage/).

### ETag strategy (authorization-aware) follow-up (#448)

Work continues to keep **etag** / **entityETag** and response headers consistent when authorization changes the response shape (see also [Release Notes v0.0.40](/blog/archive/release-v0-0-40)).
