  ...
  plugins: [
    ...
    [
      '@docusaurus/plugin-content-blog',
      {
        ...
        blogDescription: 'vNext platformu eski sürüm notları arşivi',
        showReadingTime: true,
        postsPerPage: 10,
        onInlineTags: 'warn',
        onInlineAuthors: 'warn',
    ...
    [
      '@docusaurus/plugin-content-blog',
      {
        id: 'blog-breaking-changes',
        path: 'blog-breaking-changes',
        routeBasePath: 'blog/breaking-changes',
        blogTitle: 'Breaking Changes',
        blogDescription: 'vNext platformu versiyon bazlı breaking changes',
        showReadingTime: true,
        postsPerPage: 10,
        onInlineTags: 'warn',
        onInlineAuthors: 'warn',
    ...
    [
      '@docusaurus/plugin-content-blog',
      {
        id: 'blog-migration',
        path: 'blog-migration',
        routeBasePath: 'blog/migration',
        blogTitle: 'Migration & Version Changes',
        blogDescription: 'Yeni versiyonlarda neler değişti, migration rehberleri',
        showReadingTime: true,
        postsPerPage: 10,
        onInlineTags: 'warn',
        onInlineAuthors: 'warn',
  ...
  themes: [
    ...
    [
      require.resolve('@easyops-cn/docusaurus-search-local'),
      {
        ...
        blogRouteBasePath: ['blog', 'blog/archive', 'blog/breaking-changes', 'blog/migration'],
    ...
    navbar: {
      ...
      items: [
        ...
        { to: '/product/intro', label: 'Product', position: 'left' },
        {
          ...
          position: 'left',
          items: [
            { to: '/blog', label: 'Latest Releases' },
            { to: '/blog/archive', label: 'Archive' },
            { to: '/blog/breaking-changes', label: 'Breaking Changes' },
            { to: '/blog/migration', label: 'Migration Guides' },
          ],
        },
    ...
    footer: {
      ...
      links: [
        ...
        },
        {
          title: 'More',
          items: [
            { label: 'Latest Releases', to: '/blog' },
            { label: 'Release Archive', to: '/blog/archive' },
            { label: 'Breaking Changes', to: '/blog/breaking-changes' },
            { label: 'Migration Guides', to: '/blog/migration' },
