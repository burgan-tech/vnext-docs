...
- [State Function API](/docs/components/functions/built-in#state-function) - State information structure
- [HTTP Task](./http) - HTTP task configuration
- [Dapr Bindings](https://docs.dapr.io/reference/components-reference/supported-bindings/) - Dapr binding documentation
- [Task Types](/docs/components/tasks/) - Overview of all task types
- [Workflow Definition](/docs/components/workflow) - Workflow structure and configuration
