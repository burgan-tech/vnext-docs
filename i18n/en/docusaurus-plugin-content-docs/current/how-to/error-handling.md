...
> **Schema alignment:** Workflow JSON Schema for **errorBoundary** (including **abort** actions that reference a **transition**) matches backend validators when you use **vnext-schema** and **Ajv2019** validation as described in [Schema Management](/docs/components/schema).
...
- [Workflow Definition](/docs/components/workflow) - Workflow structure and components
- [State Management](/docs/components/workflow) - State definitions and types
- [Task Management](/docs/components/tasks/) - Task types and execution
- [Transition Management](/docs/components/mappings) - Transitions and triggers