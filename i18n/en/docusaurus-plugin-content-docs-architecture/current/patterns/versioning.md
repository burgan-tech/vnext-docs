...
- [📄 Reference Schema](/architecture/patterns/references) - Inter-component reference management
- [📄 Persistence](/architecture/data/persistence) - Data storage and Dual-Write Pattern
- [📄 Workflow Definition](/docs/components/workflow) - Workflow definition and development guide