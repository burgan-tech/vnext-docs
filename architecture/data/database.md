...
```mermaid
flowchart TB
  S1["Deployment: loan-application flow (v1.0.0)"] --> S2["DB-Migrator job calisir<br/>(deployment pipeline)"]
  S2 --> S3["loan_application semasi<br/>olusturulur veya guncellenir"]
