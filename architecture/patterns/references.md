...
- **flowVersion**: Bileşenin modüldeki hangi versiyonda yükleneceği bilgisi. Sadece ana tanım bileşende `flowVersion` gereklidir. Referens kullanımında gerek yoktur.
