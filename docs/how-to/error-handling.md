...
> **Şema hizalaması:** **errorBoundary** için workflow JSON Şeması (**transition** referanslı **abort** aksiyonları dahil), **vnext-schema** ve [Şema yönetimi](/docs/components/schema) bölümündeki **Ajv2019** doğrulaması kullanıldığında backend doğrulayıcılarıyla uyumludur.
...
- [Workflow Tanımı](/docs/components/workflow) - Workflow yapısı ve bileşenleri
