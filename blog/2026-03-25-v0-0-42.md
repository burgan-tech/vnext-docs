...
Work continues to keep **etag** / **entityETag** and response headers consistent when authorization changes the response shape (see also [Release Notes v0.0.40](/blog/release-v0-0-40)).
